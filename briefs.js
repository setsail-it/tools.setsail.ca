...
async function generatePageBrief(pageIdx) {
  ...
  if (isService) {
    ...
    prompt = '## PAGE\n'
      ...
      + '### 5. EMOTIONAL ARC\n'
      + 'Map the D8 emotional journey to the page structure if available:\n'
      + '- Sections 1-2 (Hero + Credentials): Relief/Confidence\n'
      + '- Section 3 (Problem): Scar — speak from INSIDE the reader\'s experience\n'
      + '- Section 4 (Solution): Moment — the shift where they see something different\n'
      + '- Sections 5-7 (Details, Process, Proof): Trust building\n'
      + '- Sections 8-9 (Objections, FAQ): Confidence\n'
      + '- Section 10 (Final CTA): Action\n'
      + 'Note the specific emotion and language direction for each transition.\n\n'
      + '### 6. PAGE STRUCTURE (H2 SKELETON) — 10-12 sections\n'
      + 'REQUIRED sections for service pages:\n'
      + '1. Hero (H1 + CTA + trust strip) [conversion + 5-second test]\n'
      + '2. Social proof / credential bar [immediate trust]\n'
      + '3. Problem agitation — speak TO the reader from inside their experience [scar recognition]\n'
      + '4. Solution bridge — how this service solves it differently [moment/shift]\n'
      + '5. Service details — deliverables, what\'s included [trust building]\n'
      + '6. Process / methodology — how it works step by step [transparency]\n'
      + '7. Case study / proof — specific verified results [confidence]\n'
      + '8. Who this is for — qualify the visitor: industry, size, situation. Include 2-3 "this is for you if..." and 2-3 "this is NOT for you if..." [relevance]\n'
      + '9. Pricing approach / objection handling [cost + risk objections]\n'
      + '10. FAQ section (6-10 questions) [final objections + schema]\n'
      + '11. Final CTA with risk reversal [action]\n'
      + 'For each H2: note [purpose], [emotional stage], [proof signal if any].\n'
      + 'H2 QUALITY: No cliches ("bank on", "game-changer", "next level"). Prefer specific over generic — include data or specificity in at least 2 H2s. '
      + 'If a competitive differentiation section is included, specify comparison format: 3-column table preferred (Traditional | Average | Our Approach).\n'
      + 'Section-level word targets: Hero 50-80, Problem+Solution 150-200 each, Service details 300-400, Process 200-300, Proof 200-300, Who this is for 100-150, Objections 150-200, FAQ 400-600, Final CTA 50-80.\n\n'
      + '### 7. KEYWORD INTEGRATION NOTES\n'
      ...
      + '### 10. WORD COUNT + FORMAT TARGET\n'
      + 'Target word count (justify from SERP data if available). '
      + 'Recommended content format (service landing page with proof blocks, not a listicle). '
      + 'Each section should be a visually distinct block with clear heading, body, and optional CTA or proof element.\n\n'
      + '### 11. E-E-A-T + PROOF VERIFICATION\n'
    ...
    prompt = '## PAGE\n'
      ...
      + 'List all proof in two categories:\n'
      + '- **AVAILABLE (verified):** Specific proof from the PROOF & E-E-A-T SIGNALS section — only these can be stated as facts.\n'
      + '- **MISSING (needed):** What would strengthen this article? Use bracketed placeholders.\n'
      + '- **SOURCE CITATION RULE:** If the intro hook or any claim uses a statistic, specify the published source. If no source exists, reframe as a question or observation rather than a fabricated stat. Example: instead of "73% fire their agency" use "How many business owners are on their third agency?".\n'
      + '- **FABRICATION RULE:** Never invent statistics, survey results, or case study numbers. Only AVAILABLE proof can appear as factual claims.\n\n'
      + '### 9. FAQ SECTION (H3s)\n'
      + 'Use assigned questions verbatim as H3s. Note the answer angle for each (1 line).\n\n'
      + '### 10. INTERNAL LINKS + SOFT CTA\n'
      + 'Which 3-5 internal pages should this link to, and where/why? '
      + 'What soft CTA fits at the end (not pushy — this is an info page)?\n\n'
      + '### 11. WORD COUNT + SKIMMABILITY FORMAT\n'
